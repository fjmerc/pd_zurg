...
- **Activity Type column header is centered**: The TYPE header sat flush-left above centered colored badges, making the column look visually misaligned. Header and cell are both centered now, so each badge lines up directly under the word "Type".
